...
| *(Context stakeholder, not a system actor)* Data protection expectations | — | Informs NFRs around tenant isolation, access control, and data privacy, given health-adjacent data across multiple organisations |
...
FR5, FR6, FR10, FR16, FR19, FR21, FR24, FR25
